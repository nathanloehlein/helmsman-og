...
- User-facing terminology: call a repository a "galleon" (plural "galleons") in Helmsman's UI and conversation. Preserve technical identifiers, API fields, configuration keys, and Git commands.
