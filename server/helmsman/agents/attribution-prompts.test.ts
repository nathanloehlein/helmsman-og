...
describe('agent attribution in prompts', () => {
  ...
  it.each(['implement', 'fix', 'review'] as const)('preserves pre-PR publication boundaries for %s', stage => {
    ...
    expect(prompt).toContain(`_Helmsman · gpt-5.6-sol - high_`);
