export const TERMINOLOGY = {
  ...
  tokens: { plain: 'Tokens', pirate: 'Tokens' },
  ...
  launchTicket: { plain: 'Start ticket run', pirate: 'Start ticket voyage' },
  launchRun: { plain: 'Start run', pirate: 'Weigh anchor' },
  runPr: { plain: 'Review or update a PR', pirate: 'Review or update a bounty' },
  ...
  codeReview: { plain: 'Start agent review', pirate: 'Start deckhand review' },
